...
$main_page 	= "Link Content"; //for sidebar active menu
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content">
		<input type="hidden" name="link_id" id="link_id" value="<?php echo $_REQUEST['id']; ?>">
		<div class="row">
			<div class="col-md-12">
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_vendor_team_content.php?show=" + numRecords + "&searchName=" + searchName + "&link_id=" + link_id;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-vendor-team-content/delete/'+id+'/';
		}
	}
