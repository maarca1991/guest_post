...
$ctable1 	= "Black List";
$main_page 	= "Black List"; //for sidebar active menu
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_black_list.php?show=" + numRecords + "&searchName=" + searchName;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-black-list/delete/'+id+'/';
		}
	}
