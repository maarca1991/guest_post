...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_seo_team_url_link.php?show=" + numRecords + "&searchName=" + searchName + "&url_id=" + url_id;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-seo-team-url-link/delete/'+id+'/';
		}
	}
