...
$url_link_id_q = $db->rpgetJoinData("url as u","url_link as ul","u.id = ul.url_id AND ul.isDelete=0 AND content_id=".$_SESSION[SESS_PRE.'_CONTENT_SESS_ID'],"ul.id as link_id");
...
$ctable_where .= " isDelete=0 AND link_id IN (".$implod_link_array.")";
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>approve-head-content/edit/<?php echo $ctable_d['id']; ?>/" title="Content Approval"><i class="fa fa-pencil"></i></a>
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-default m-b-5" href="<?php echo ADMINURL?>assign-link-content-team/assign/<?php echo $ctable_d['id']; ?>/" title="Assign Team Member"><i class="fa fa-user"></i></a>
							<?php }else{ ?>
								<a class="btn btn-xs btn-icon waves-effect waves-light btn-success m-b-5" href="<?php echo ADMINURL?>approve-head-content/view/<?php echo $ctable_d['id']; ?>/" title="View Content"><i class="fa fa-eye"></i></a>
