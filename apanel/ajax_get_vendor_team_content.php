...
$ctable_where .= " isDelete=0 AND link_id=".$link_id." AND vendor_team_id=".$_SESSION[SESS_PRE.'_VENDOR_TEAM_SESS_ID'];
...
<form action="" name="frm" id="frm" method="post">
	...
	<input type="hidden" name="hdndb" value="<?php echo $ctable; ?>">
		...
		<button type="button" class="btn btn-inverse sidebar m-t-10" style="margin-bottom: 5px;" onclick="window.location.href='<?php echo ADMINURL; ?>manage-vendor-team-url-link/<?php echo $url_id; ?>'" title="back"><i class="fa fa-reply"></i></button>
