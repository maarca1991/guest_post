...
<form action="" name="frm" id="frm" method="post">
	...
	<input type="hidden" name="hdndb" value="<?php echo $ctable; ?>">
		...
		<button type="button" class="btn btn-inverse sidebar m-t-10" style="margin-bottom: 5px;" onclick="window.location.href='<?php echo ADMINURL; ?>manage-client-url-link/<?php echo $url_id; ?>'" title="back"><i class="fa fa-reply"></i></button>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>approve-content/edit/<?php echo $ctable_d['id']; ?>/" title="Content Approval"><i class="fa fa-pencil"></i></a>
							
							<?php }else{ ?>
								<a class="btn btn-xs btn-icon waves-effect waves-light btn-success m-b-5" href="<?php echo ADMINURL?>approve-content/view/<?php echo $ctable_d['id']; ?>/" title="View Content"><i class="fa fa-eye"></i></a>
							<?php } ?>
						</td>
					</tr>
					<?php
