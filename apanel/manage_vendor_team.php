...
$ctable 	= "admin";
$ctable1 	= "Vendor Team";
$main_page 	= "vendor_team"; //for sidebar active menu
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_<?php echo $main_page; ?>.php?show=" + numRecords + "&searchName=" + searchName;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-vendor-team/delete/'+id+'/';
		}
	}
