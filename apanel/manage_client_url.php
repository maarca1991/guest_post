<?php
include("connect.php");
if(isset($_SESSION[SESS_PRE.'_CLIENT_SESS_ID']) && "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]" == ADMINURL.'manage-client-url/'){
...
$ctable 	= "url";
$ctable1 	= "Url";
$main_page 	= "Url"; //for sidebar active menu
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_client_url.php?show=" + numRecords + "&searchName=" + searchName;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-client-url/delete/'+id+'/';
		}
	}
