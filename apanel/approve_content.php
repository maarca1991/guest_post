...
if(isset($_REQUEST['submit']))
{
	...
	if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="edit")
	{
		$array = array(
			...
			"status" 	=> $status,
			"clientEditDate" => date('Y-m-d H:i:s')
		);
	...
	$db->rplocation(ADMINURL."manage-client-content/".$link_id);
}
					...
					<form role="form" name="frm" id="frm" action="." method="post" enctype="multipart/form-data">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<?php } ?>
								<button type="button" class="btn btn-inverse waves-effect w-md waves-light" onClick="window.location.href='<?= ADMINURL ?>manage-client-content/<?php echo $link_id; ?>'">Back</button>
							</div>
						</div>
					</form>
				</div>
