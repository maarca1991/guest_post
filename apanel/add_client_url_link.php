...
if(isset($_REQUEST['submit']))
{
	...
	$db->rplocation(ADMINURL."manage-client-url-link/".$url_id);
}
					...
					<form role="form" name="frm" id="frm" action="." method="post" enctype="multipart/form-data">
						...
						<div class="box-body">
							...
							<div class="box-footer">
								...
								<?php } ?>
								<button type="button" class="btn btn-inverse waves-effect w-md waves-light" onClick="window.location.href='<?= ADMINURL ?>manage-client-url-link/<?php echo $url_id; ?>'">Back</button>
							</div>
						</div>
					</form>
				</div>
