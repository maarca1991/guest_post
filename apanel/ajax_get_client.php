...
$ctable_where .= " isDelete=0 AND role=5";
...
<form action="" name="frm" id="frm" method="post">
	...
	<input type="hidden" name="hdndb" value="<?php echo $ctable; ?>">
		...
		<?php
			$db->getDeleteButton();
			echo $db->getAddButton1("client",$ctable1);
		?>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>add-client/edit/<?php echo $ctable_d['id']; ?>/" title="Edit"><i class="fa fa-pencil"></i></a>
