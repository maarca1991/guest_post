...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_client_content.php?show=" + numRecords + "&searchName=" + searchName + "&link_id=" + link_id;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-client-content/delete/'+id+'/';
		}
	}
