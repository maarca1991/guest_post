...
$ctable_where .= " isDelete=0 AND vendor_team_id=".$_SESSION[SESS_PRE.'_VENDOR_TEAM_SESS_ID'];
			...
			<tbody>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							<!-- <a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>add-vendor-url/edit/<?php echo $ctable_d['id']; ?>/" title="Add Link"><i class="fa fa-plus"></i></a> -->
							...
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>manage-vendor-team-url-link/<?php echo $ctable_d['id']; ?>/" title="Add Link"><i class="fa fa-plus"></i></a>
