...
$ctable 	= "url_link";
$ctable1 	= "Url Link";
$main_page 	= "Url Link"; //for sidebar active menu
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content">
		<input type="hidden" name="url_id" id="url_id" value="<?php echo $_REQUEST['id']; ?>">
		<div class="row">
			<div class="col-md-12">
...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_vendor_team_url_link.php?show=" + numRecords + "&searchName=" + searchName + "&url_id=" + url_id;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-vendor-team-url-link/delete/'+id+'/';
		}
	}
