...
$ctable_where .= " isDelete=0 AND url_id=".$url_id." AND vendor_team_id=".$_SESSION[SESS_PRE.'_VENDOR_TEAM_SESS_ID'];
...
<form action="" name="frm" id="frm" method="post">
	...
	<input type="hidden" name="hdndb" value="<?php echo $ctable; ?>">
		...
		?>
		<a class="btn btn-primary sidebar m-t-10" style="margin-bottom: 5px;" href="<?php echo ADMINURL?>add-vendor-team-url-link/add/<?php echo $url_id; ?>"><i class="fa fa-plus"></i></a>

		<button type="button" class="btn btn-inverse sidebar m-t-10" style="margin-bottom: 5px;" onclick="window.location.href='<?php echo ADMINURL; ?>manage-vendor-team-url/'" title="back"><i class="fa fa-reply"></i></button>
				...
				if(@mysqli_num_rows($ctable_r)>0){
					...
					<tr>
						...
						<td>
							...
							<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>add-vendor-team-url-link/edit/<?php echo $ctable_d['id']; ?>/" title="Edit Link"><i class="fa fa-pencil"></i></a>
							...
							<?php }else{ ?>
								...
								<?php if($ctable_d['clientEditDate'] != null || $ctable_d['seoEditDate'] != null || $ctable_d['seoTeamEditDate'] != null && $ctable_d['status'] == 1){ ?>
									<a class="btn btn-xs btn-icon waves-effect waves-light btn-primary m-b-5" href="<?php echo ADMINURL?>manage-vendor-team-content/<?php echo $ctable_d['id']; ?>/" title="Add Content"><i class="fa fa-plus"></i></a>
								<?php } ?>
							<?php } ?>
						</td>
					</tr>
