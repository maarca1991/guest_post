...
<script type="text/javascript">
	...
	function displayRecords(numRecords) {
		...
		var data_url    = "<?php echo ADMINURL?>ajax_get_team_content.php?show=" + numRecords + "&searchName=" + searchName + "&url_id=" + url_id;
		$("#results").html("");
		$(".loading-div").show();
	...
	function del_conf(id){
		...
		if(r){
			window.location.href='<?php echo ADMINURL?>add-team-content/delete/'+id+'/';
		}
	}
