	...
	<tr>
		<td style="padding:30px 0px 0px 0px; background-color: #fff;border:none; border-radius: 5px;">
			<table width="100%" border="0" style="text-align: center">
				<tr>
					<p>Hello Admin,</p>
					<p>You have received new website url which is created by '.$_SESSION[SESS_PRE.'_CLIENT_SESS_NAME'].'</p>
					<p>Details are below.</p>
				</tr>
				<tr>
					<td style="font-size: 14px; font-weight:normal;padding:0 30px 30px;line-height: 20px;"> Website Url : '.$url.'
					</td>
				</tr>
			</table>
		</td>
